...
import com.adam.imgpicker.compress.tiny.common.TinyException;
import com.adam.imgpicker.compress.tiny.common.UriUtil;
import com.adam.imgpicker.compress.tiny.core.CompressKit;
import com.adam.imgpicker.compress.tiny.core.FileCompressor;
...
import static com.adam.imgpicker.compress.tiny.core.BitmapCompressor.compress;
...
public class FileCompressCallableTasks {
    ...
    public static final class BitmapAsFileCallable extends BaseFileCompressCallable {
        ...
        @Override
        public CompressResult call() throws Exception {
            Bitmap bitmap = compress(mBitmap, mCompressOptions, false);
